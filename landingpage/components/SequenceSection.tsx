...
import { ArrowRight, Lightbulb, UserPlus, FileCode, CheckCircle, CreditCard } from 'lucide-react';
...
const SequenceSection: React.FC = () => {
  const steps = [
    ...
    { name: 'RELEASE', icon: FileCode, color: 'puce-pink', desc: 'Submit the code and pull request link.' },
            ...
            <React.Fragment key={step.name}>
              ...
              {idx < steps.length - 1 && (
                <div className="hidden lg:block">
                  <ArrowRight className="text-gray-700 animate-pulse-subtle" size={24} />
                </div>
              )}
            </React.Fragment>
          ))}
