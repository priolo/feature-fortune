...
function RouterProvider({
  ...
  let [state, setStateImpl] = React3$1.useState(router2.state);
  ...
  React3$1.useLayoutEffect(() => router2.subscribe(setState), [router2, setState]);
  React3$1.useEffect(() => {
...
function ServerRouter({
  ...
  return /* @__PURE__ */ React$1.createElement(React$1.Fragment, null, /* @__PURE__ */ React$1.createElement(
    ...
    /* @__PURE__ */ React$1.createElement(RemixErrorBoundary, { location: router2.state.location }, /* @__PURE__ */ React$1.createElement(
...
function RSCHydratedRouter({
  ...
  if (payload.type !== "render") throw new Error("Invalid payload type");
  let { router: router2, routeModules } = React4.useMemo(
  ...
  let [location2, setLocation] = React4.useState(router2.state.location);
  React4.useLayoutEffect(
...
//# sourceMappingURL=__federation_shared_react-router-dom-BHv8CyIO.js.map
