...
import paymentApi from "../../api/payment-Bf3tKKx1.js";
...
import { useStripe, useElements, CardElement } from "../../node_modules/@stripe/react-stripe-js/dist/react-stripe.esm-C9QpMAFV.js";
import { r as reactExports } from "../../_virtual/index-CKgvjd_4.js";
import CreditCardViewer from "./CreditCardViewer-B956iG-C.js";
...
import Money from "../../node_modules/@mui/icons-material/esm/Money-Cyiz5ts2.js";
const StripeCreditCard = ({}) => {
  var _a;
  const havePaymentMethod = (_a = authSo.state.user) == null ? void 0 : _a.stripeHaveCard;
  yn(authSo);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Card,
    {
      ...
      children: [
        ...
        !!havePaymentMethod ? /* @__PURE__ */ jsxRuntimeExports.jsx(CreditCardViewer, { card: paymentMethod == null ? void 0 : paymentMethod.card }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CardElement, { className: "stripe-card-element" }),
...
export {
  StripeCreditCard as default
};
//# sourceMappingURL=StripeCreditCard-BRUgq8sq.js.map
