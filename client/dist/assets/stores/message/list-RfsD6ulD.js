...
import { MESSAGE_ROLE } from "../../types/Message-DohVTP9Q.js";
...
const setup = {
  ...
  actions: {
    async fetch(_, store) {
      var _a;
      const messages = (_a = await messageApi.index(MESSAGE_ROLE.RECEIVER)) == null ? void 0 : _a.messages;
    ...
    async remove(messageId, store) {
      var _a;
      const res = (_a = await messageApi.remove(messageId)) == null ? void 0 : _a.success;
...
export {
  messageListSo as default
};
//# sourceMappingURL=list-RfsD6ulD.js.map
